...
const page = () => {
	return (
		<div className='m-auto mt-24 w-[50%]'>
			<div>
				<h1 className='font-inter text-3xl text-blackOne'>
					...
					<div className='flex justify-between'>
						...
						<div className='flex flex-col gap-4'>
							<p className='h-[70px] '>
								...
								l’identité que sur le contenu des échanges. En tant que
								coach je suis tenu au secret professionnel et garde
								strictement confidentiels le contenu et l’identité de la
								personne accompagnée.
							</p>
							<p className='h-[70px] '>
								<strong> 2. Transparence</strong> : tout sera pleinement
								exposé et explicité pour garantir un sentiment de
								sécurité et de tranquillité.
							</p>
							<p className='h-[70px] '>
								<strong> 3. Liberté</strong> : vous aurez le choix plein
								et entier à tout moment de vos actions pour vous
								garantir une parfaite autonomie et vous laisser la
							...
							<p className='h-[70px] '>
								...
								cadre afin de vous permettre de ressortir plus apaisé.
							</p>
						</div>
					</div>
